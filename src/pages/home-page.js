			...
			<Layout>
				<div className="tw-relative">
					...
					<div className="tw-z-40 tw-h-[100vh] tw-mt-[-70px] tw-w-[100%] bg-blur3 tw-absolute tw-top-0 tw-bottom-0 z-10 tw-items-center tw-justify-center tw-flex tw-flex-col">
						...
						<div className="tw-text-neutral-600 tw-text-[40px] md:tw-text-[50px] tw-flex tw-flex-col tw-items-center">
						...
						<div className="tw-rounded-full progress tw-w-[50%] tw-mt-20 tw-bg-neutral-900 ">
							<div className="inner tw-bg-neutral-700"></div>
						</div>
						<div className="social-media-list tw-mt-[200px]">
							<a
